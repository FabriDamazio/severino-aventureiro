...
public partial class Character : CharacterBody3D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
      ...
      // Wrap method to wrap the angle between -Pi and Pi.
        ...
        if (_direction != Vector3.Zero)
        {
            _xzVelocity = _xzVelocity.MoveToward(_direction * _walkingSpeed, _acceleration * (float)delta);
        }
        else
        {
        ...
        _animation.Set("parameters/Locomotion/blend_position", _xzVelocity.Length() / _walkingSpeed);
